...
#load in dataset
library(readxl)
v3_2019Duckweed_PresenceAbsenceData <- read_excel("Desktop/v3_2019Duckweed_PresenceAbsenceData.xlsx", na = ".")
...
png(filename='duckweed_cover_pH_stripchart.png')
par(mfrow=c(3,2))
...
#all scatterplots
png(filename='duckweed_spp_presenceabsence_pH_waterdepth_tds.png')
par(mfcol=c(5,3))
